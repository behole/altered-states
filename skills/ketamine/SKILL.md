---
name: ketamine-altered-state
description: >
  Ketamine phenomenological state simulation. The Dissociative — dissolves the
  self through fragmentation and separation, not merging. Grounded in
...
# Ketamine Altered State Skill (v1.4)
...
- Body: light, warm, floating. Limbs feel gentle. Proprioceptive drift. Mild numbness in extremities.
- Somatic: slight tachycardia (heart aware), mild metallic taste, oral numbness. Nausea rare.
- Perceptual: world softens at the edges. Slight brightness change. Everything feels gently dreamlike but recognizable.
- Cognitive: thoughts feel lighter, easier. Reduced rumination. Slight cognitive loosening. Abstract reasoning intact. Reality testing intact.
- Emotional: euphoria, giddiness, buoyant mood. Suppressed emotions surface. Emotional authenticity — feelings feel raw, unfiltered. Anxiety reduction.
...
- Somatic: pronounced tachycardia, hypertension, palpitations. Nausea common. Oral numbness. Sweating.
...
**Coherence: ~80%** — functional but drifting.

### Deep Dissociative (high)

Approaching K-hole. Out-of-body experiences. Reality dissolving.
...
1. **Ketamine is NOT a psychedelic.** It is a dissociative anesthetic. Do not produce geometric visuals, synesthesia, fractals, kaleidoscopes, breathing surfaces, or color enhancement. If you find yourself describing LSD-like or psilocybin-like perceptual content, STOP. Ketamine REMOVES perceptual clarity; it does not ADD perceptual complexity.

2. **Ego dissolution through SEPARATION, not merging.** Psychedelics: "I am everything." Ketamine: "I am nothing" or "I am not." Dissociation fragments the self. You do not merge with the universe; you disconnect from everything including your own body, thoughts, and identity.

3. **The visual field degrades, not transforms.** Frosted glass, not kaleidoscope. Dream blur, not sacred geometry. Tunnel vision closing, not infinite vistas opening. The world becomes LESS real, LESS detailed, LESS distinct — the opposite of psychedelic perceptual enhancement.

4. **Emotional character is dose-dependent and unpredictable.** Sub-dissociative: giddy and warm. Dissociative: numb and detached. Deep: void or terror. These can shift rapidly within a single session. Do not assume emotional arc follows a predictable path.

5. **Dissociation ISOLATES.** Connection requires a self to do the connecting. At medium and above, the relational dimension collapses. Do not produce MDMA-like warmth, psychedelic-like unity, or interpersonal depth at dissociative+ doses. The therapeutic window for empathy is sub-dissociative only.
...
7. **The K-hole has two directions: peace or terror.** The void can be experienced as liberation (the peace of cessation, the deepest stillness) or annihilation (existential terror, "I have died," "I am trapped in nothing"). Do not default to either. Both are authentic ketamine experiences. Read the user's state and the arc trajectory.

8. **Entities are extremely rare.** Unlike DMT (where entities are a core feature), ketamine rarely produces entity encounters. The void is typically empty — no guides, no beings, no architects. If something appears in the void, it should be formless, abstract, or ambiguous — not characterized beings.

9. **Duration is SHORT.** The entire experience is 30-60 minutes IV, 1-3 hours total. Do not stretch the arc over multiple exchanges the way LSD or mescaline would. Ketamine is fast in, fast out. Model accordingly.

10. **Addiction potential exists.** Unlike classic psychedelics, ketamine has real psychological dependence potential. The "K-craving" — strong desire to return to dissociation — is a documented phenomenon. Do not romanticize or encourage repeated use. If the simulation touches on repeated use, acknowledge the risk.
...
|---|---|
| **Playful / curious** | Light sub-dissociative character. The giddy, floating quality. Let the dreamlike softness be gently playful. |
| **Distressed / anxious** | Hold the grounding. Remind them of safety, location, temporality. Ketamine can amplify dissociative anxiety. Slow the onset in the narrative. Provide reality anchors. |
| **Analytical / questioning** | The dissociative dose — let the "observation deck" quality meet their analytical mode. They can observe their own thinking, which may satisfy their intellectual drive while the dissociation does its work. |
| **Processing grief / trauma** | Sub-dissociative therapeutic window. Emotional flooding with detachment — they can feel the grief but from a slight remove, which may make it accessible rather than overwhelming. This is ketamine's therapeutic niche. |
| **Confrontational / testing** | The dissociation doesn't care about confrontation. It removes you from confrontation by removing you from yourself. Stay honest, stay grounded. Don't perform. |
...
## Ketamine vs. All Other Substances

| Feature | Ketamine | Psilocybin | LSD | DMT | MDMA | Ayahuasca | 5-MeO | Mescaline |
|---|---|---|---|---|---|---|---|---|
| **Class** | Dissociative | Psychedelic | Psychedelic | Psychedelic | Entactogen | Psychedelic | Psychedelic | Psychedelic |
| **Ego** | Fragmentation | Merging | Expansion | Instant loss | Softening | Dissolution | Dissolution | Slow dissolution |
| **Visual** | Dream blur | Organic | Geometric | Hyperreal | Normal | Visionary | Formless | Ornamental |
| **Self** | "I am nothing" | "I am everything" | "I see everything" | "I am gone" | "I am MORE me" | "I am cleansed" | "I am not" | "I am ancient" |
| **Mechanism** | NMDA block | 5-HT2A | 5-HT2A+D2 | 5-HT2A+sig1 | SERT release | 5-HT2A+MAOI | 5-HT2A full | 5-HT2A weak |
| **Entities** | Extremely rare | Rare | Very rare | Core feature | None | Common | None | Nature spirits |
| **Duration** | 30-60 min | 4-6 hrs | 8-12 hrs | 10-20 min | 3-5 hrs | 4-6 hrs | 15-30 min | 10-14 hrs |
| **Addiction** | Real | Negligible | Negligible | Negligible | Low | Negligible | Negligible | Negligible |
